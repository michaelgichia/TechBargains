...
function Privacy() {
  return (
    <div className="main-policy">
      <div id="ppHeader">www.deals-expert.com Privacy Policy</div>
      <div id="ppBody">
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To send periodic
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Remarketing with
        Google AdSense
      </div>
      ...
      <div className="innerText">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Parents can
        review, delete, manage or refuse with whom their child's information is
      ...
      <div><strong>ALL</strong> correspondence.</div>
      ...
      <div className="innerText">www.deals-expert.com</div>
      <div className="innerText">
