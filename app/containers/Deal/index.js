...
export class Deal extends React.PureComponent { // eslint-disable-line react/prefer-stateless-function
  state = {
    deals: [],
    errors: '',
  }
  ...
  renderDeals = (deals) => deals.map((deal) => <CouponDetail coupon={deal} key={shortid.generate()} />)
